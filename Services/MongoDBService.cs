...
namespace BlogApplication.Services
{
    public class MongoDBService
    {
        ...
        public MongoDBService(IConfiguration configuration, IWebHostEnvironment webHostEnvironment, ILogger<MongoDBService> logger)
        {
            _logger = logger;
            var connectionString = configuration.GetConnectionString("MongoDBConnection")
                ?? "mongodb+srv://mongodb:mongodb@cluster0.1r7vp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
            try
            {
